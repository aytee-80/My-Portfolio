// Source: React Bits — SideRays (JS-CSS variant)
// Registry source, unmodified. Requires: ogl@^1.0.11 (same dependency as
// LightRays — already installed if that component was added first).
